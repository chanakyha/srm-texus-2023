...
const PrivacyPolicy = () => {
  return (
    <div className="w-screen min-h-[calc(100vh-330px)] bg-[url('https://res.cloudinary.com/dwncfhjpd/image/upload/v1678565057/texus/bgoverlay_cvgli3.png')] bg-cover md:bg-contain bg-no-repeat bg-center">
      <div className="p-4 pt-0 md:p-16 md:pt-0 lg:pt-0 lg:max-w-6xl lg:mx-auto">
        <h1 className="text-3xl">Privacy Policy</h1>
        <div className="flex flex-col gap-6 mt-6">
          {policies?.map((policy) => {
            return <p className="text-justify text-slate-200">{policy}</p>;
          })}
        </div>
      </div>
    </div>
