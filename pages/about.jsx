        ...
        <div className="w-full lg:bg-[url('https://res.cloudinary.com/dwncfhjpd/image/upload/v1678565057/texus/bgoverlay_cvgli3.png')] bg-top bg-cover bg-no-repeat">
          <div className="p-4 md:p-16 mt-16 max-w-6xl mx-auto">
            ...
            <p className="text-gray-300 text-justify mt-3">
              Texus is a cultural extravaganza, from Technical to Non-Technical, where both the worlds colloide. It is a 2 day-National Level Tech Fest organised by the Department of Computer Science and Engineering, SRM Institute of Science and Technology, Ramapuram. With our exciting lineups of Hackathons, Technical Events, Non-Technical events, Culturals, Blood donation camp, Exhibition and Musical Nights, it’s all thrills up at Texus.
              This Proves to be an ultimate platform for students to come together and unleash their inner-self.
            </p>
          </div>
