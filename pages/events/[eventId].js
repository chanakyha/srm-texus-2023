...
const EventDescription = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-black font-montserrat">
      <Image
        alt=""
        className="p-20 pb-10"
        src={require("../../assets/images/event-desc.png")}
      />

      <div className="p-20 pt-0 text-lg font-semibold">
        <p className="text-[#FF6240] cursor-pointer underline underline-[#FF6240]">
          Back to all events
        </p>
        <div className="mt-5 flex justify-between items-center">
          <div>
            <h1 className="text-white text-6xl">{event?.eventName}</h1>
            <p className="text-[#747474] capitalize">By {event?.clubName}</p>
          </div>
