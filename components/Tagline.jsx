...
const Tagline = () => {
    return (
        <div class="relative flex bg-black text-white overflow-x-hidden bg-[url('../assets/images/eventcard.png')] w-full bg-fill bg-no-repeat bg-top">
        <div class="my-12 animate-marquee whitespace-nowrap">
            <span class="lg:text-4xl md:text-xl text-lg mx-4">Marquee Item 1</span>
            <span class="lg:text-4xl md:text-xl text-lg mx-4">&#9733;</span>
