...
const Landing = () => {
    ...
    return (
        <section className="w-full h-full bg-black relative max-w-5xl mx-auto">
            ...
            <div className="absolute top-0 w-full h-full flex justify-evenly items-center">
                {texusArray.map((item, index) => (
                    <span key={index} className="text-white text-6xl text-center textSpan">{item}</span>
                ))}
            </div>
