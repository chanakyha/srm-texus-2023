...
function Footer() {
  ...
  return (
    <footer className="flex flex-col justify-center py-5 px-15  bg-white dark:bg-black text-white ">
        <div className="bg-[url('../assets/images/footer.png')] bg-left-top bg-cover bg-no-repeat ">
        <div className="flex justify-center">
            <Link href="#" className='tracking-[1rem] text-xl font-sniglet p-2'>TEXUS</Link>
        </div>
        <div className="flex md:flex-row flex-col justify-center md:space-x-10 items-center p-2">
                {contents.map((content, key) => {
                    ...
                    <p
                        key={key}
                        className="tracking-wide text-xl font-sniglet"
                    >
                        {content}
                    </p>
                    );
