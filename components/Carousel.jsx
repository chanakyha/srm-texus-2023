...
return (
    <div className="carousel-container max-w-5xl mx-auto flex justify-center items-center my-16">
    <Swiper
        className="flex items-center align-items justify-center bg-transparent rounded-xl"
