        ...
        <div className="mx-auto max-w-screen-xl py-8 px-4">
            <div className="md:flex md:justify-between">
                ...
                <div className="grid grid-cols-1 w-full text-center gap-5 items-center md:grid-cols-2 lg:grid-cols-5">
                    <Link href="#" className="text-sm font-semibold">Events</Link >
                    <Link href="#" className="text-sm font-semibold">About</Link >
                    <Link href="#" className="text-sm font-semibold">Schedule</Link >
                    <Link href="#" className="text-sm font-semibold">Sponsors</Link >
                    <Link href="#" className="text-sm font-semibold">Contact</Link >
                </div>
            </div>
            <hr className="my-6 border-[#777a85] sm:mx-auto " />
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-center">
                <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-center">
                    <Link href="#" className='hover:text-white md:mb-0 text-[12px] text-[#777a85]'>
                        Privacy Policy
                    </Link>
                    <Link href="#" className='hover:text-white md:mb-0 text-[12px] text-[#777a85]'>
                        Terms & Conditions
                ...
                <div className="mt-4 sm:mt-0">
                    <Link href="https://www.instagram.com/texus_2k23/" className="hover:text-gray-300 flex space-x-2 justify-center items-center">
